    ...
    <>
      <div className="container">
        ...
        <div className="navbar">
          <div className="div">
            ...
            <div className="div1">
              ...
              <span className="span">
                <span data-type="span" className="text02">
                  <span className="text03">Play</span>
                </span>
              </span>
              <Link href="/about-me" className="thqLink">
                <a className="link02">About</a>
              </Link>
            </div>
          </div>
        </div>
        <div id="playground-intro" className="div2">
          <h1 className="thqHeading1 text05">
            <span className="text06">Playground</span>
          </h1>
          ...
          <div className="container02">
            <div className="container03">
              <a
                ...
                className="link03"
              >
                <div id="btn-instagram" className="thqLink container04">
                  <span className="text08">
                    <span className="text09">View my Instagram</span>
                  </span>
                </div>
              </a>
            </div>
            <div className="container05">
              <a
                ...
                className="link04"
              >
                <div id="btn-instagram" className="thqLink container06">
        ...
        <div className="container08">
          <img src="/playground_assets/madras-central-1200h.png" className="thqImage image1" />
          <img src="/playground_assets/Gwen_Spiderverse-1200h.png" className="thqImage image2" />
          <img src="/playground_assets/Swat-Kats-1200h.png" className="thqImage image3" />
          <img src="/playground_assets/Kalam_Memorial-1200h.png" className="thqImage image4" />
          <img
          ...
          />
          <img src="/playground_assets/3%20Robots_LDR-1200h.png" className="thqImage image8" />
        </div>
