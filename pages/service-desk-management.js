  ...
  return (
    <>
      <div className="container">
        ...
        <div id="cs2-role" className="container04">
        ...
        <div id="cs2-problem" className="div2">
        ...
        <div id="cs2-deadline" className="container07">
          <div className="container08">
            ...
            <h1 className="thqHeading1 text15">Timeline:</h1>
            <span className="text16">~ 10 weeks</span>
          </div>
        </div>
        <div id="cs2-process" className="container09">
        ...
        <div id="cs2-comp-analysis-pic" className="container12">
          <img
        ...
        <div id="cs2-userflows" className="container17">
        ...
        <div id="cs2-user-flows-pic" className="container18">
        ...
        <div id="cs2-ia-desc" className="container20">
        ...
        <div id="cs2-user-flows-pic" className="container21">
          ...
          <div className="container22"></div>
        </div>
        <div id="cs2-branding" className="container23">
        ...
        <div id="cs2-solution" className="container24">
        ...
        <div id="cs2-sol-home-pic" className="container28">
        ...
        <div id="cs2-sol-pool" className="container29">
        ...
        <div id="cs2-sol-pool-pic" className="container31">
          <img
        ...
        <div id="cs2-sol-pool" className="container32">
        ...
        <div id="cs2-sol-ticket-pic" className="container34">
          <img
        ...
        <div id="cs2-sol-manager" className="container35">
          <div className="container36">
            ...
            <span className="text67">
              â¢ Supervisor will have a bird&apos;s eyes view about the happenings in their group.
              They can pin ticket&apos;s manage alerts, and customise the homepage to their
              requirements.
              <br />
        ...
        <div id="cs2-sol-ticket-pic" className="container37">
        ...
        <div id="cs2-final thoughts" className="container38">
